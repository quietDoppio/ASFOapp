...
import com.example.asfoapp.presentation.screens.recipe.adapters.IngredientsAdapter
import com.example.asfoapp.presentation.screens.recipe.adapters.MethodAdapter
...
class RecipeFragment : Fragment() {
    ...
    private fun initUi(recipeState: RecipeState) {
        ...
        Log.d(LogConfig.LOG_TAG, "RecipeFragment, initUi, isFavorite = ${recipeState.isFavorite} ")
